...
\begin{document}
  ...
  %{\includegraphics[width=8cm]{figures/uni_logo.png}};
	...
	\begin{columns} % See Section 4.4
		...
		\block{Introduction}{
			\begin{itemize}
				\item The speed of RNA polymerase II (Pol II) elongation, measured in the number of nucleotides synthesized per unit of time, plays an important role in RNA metabolism. Changes in Pol II speed can affect several co-transcriptional processes
				\parencite{munizRNAPolymeraseII2021}.
				
					\item A recent study of  \textcite{debesAgeingassociatedChangesTranscriptional2023} showed that organism aging is associated with an increase in Pol II speed, whereas lifespan-prolonging interventions tend to decrease it. 
					
					\item We present a novel computational method that jointly estimates changes in the Pol II speed and the speed of intron splicing, using total RNA-seq.
		...
		\block{Method}{
		\begin{itemize}
				\item   Our method works with total RNA-seq, which consists of both the nascent RNA and mature mRNA. Changes in gene expression affect both the nascent and mature components, while changes in Pol II speed and splicing time affect the nascent RNA only.
		...
		\begin{center}
			\includegraphics[width=0.5\linewidth]{figures/total_rna_with_bg.png}\\[1ex]
