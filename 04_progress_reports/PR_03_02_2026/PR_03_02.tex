...
\begin{frame}
	...
	\pause
	\begin{enumerate}
		\item Expression rate (how often is gene transcribed)
		\pause
...
\begin{frame}
	\frametitle{Changes in gene expression}	
	\pause
	\begin{itemize}
		\item Changes in gene expression (i.e., transcription initiation rate) scales the abundance of both nascent and mature RNA of that gene.	
	\end{itemize}	
		\begin{center}
...
\begin{frame}
	...
	\begin{itemize}
		...
		contain more unspliced introns.
	\end{itemize}	
	\vspace{1em}
	\begin{center}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Intron splicing (and degradation) speed $k_{splice}, [k_{splice}] = s^{-1} $
		\item RNA degradation $k_{deg}, [k_{deg}] = s^{-1}$
	\end{itemize}
	\textbf{Other} symbols: 
	\begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pause
		\item Observations are the reads counts (exonic and intronic), and locations (i.e., histogram) of intronic reads.
		\pause
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pause
		\item Gradient-based methods (e.g., L-BFGS algorithm) may get stuck in local minima. Is there some way to always find the global minimum of a non-convex function? 
		\pause
		\begin{itemize}
